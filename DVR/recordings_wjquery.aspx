			...
			<script>
			    jQuery.extend({
			        ...
			        setTitles: function () {
                        ...
                        sessionStorage.rTitle = sessionStorage.campus + ' ' + title[2] + ' ' + title[1] + ' ' + svc;
			    ...
			    $('#campuses-live').live('pageshow', function () {
			        ...
			        if (params.clipUrl && params.start) {
			            alert(params.clipUrl + ' start at ' + params.start);
			            selClip = params.clipUrl + '/manifest.f4m?DVR&wowzadvrplayliststart=' + params.start;
			            start = params.start;
			        } else {
			            start = 0;
			        }
			        ...
			        jQuery.setTitles();
			        selClip = sessionStorage.selClip + '/manifest.f4m?DVR&wowzadvrplayliststart=' + start;
			        sessionStorage.pageUrl = 'http://www.ccvonline.com/commandcenter/dvr/recordings.aspx&CID=' + sessionStorage.campus + '&clipUrl=' + selClip + '&start=' + start;
			        ...
			        flowplayer("player", "../flowplayer/flowplayer-3.2.9.swf",
				    {
				        ...
				        clip: {
				            ...
				            linkUrl: sessionStorage.pageUrl,
				            onPause: function (clip) {
				                sessionStorage.start = $this.getTime();
				                clip.preventDefault();
				            }
				        },
				        controls: {
